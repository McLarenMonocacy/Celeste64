...
public readonly struct Vertex(Vec3 position, Vec2 texcoord, Vec3 color, Vec3 normal, Vec4 joint, Vec4 weight) : IVertex
{
	...
	[
		new VertexFormat.Element(0, VertexType.Float3, false),
		new VertexFormat.Element(1, VertexType.Float2, false),
		new VertexFormat.Element(2, VertexType.Float3, true),
		new VertexFormat.Element(3, VertexType.Float3, false),
		new VertexFormat.Element(4, VertexType.Float4, false),
		new VertexFormat.Element(5, VertexType.Float4, false),
	]);
}